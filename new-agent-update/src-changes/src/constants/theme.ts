...
export const tiles = {
  ...
  zikr: { from: '#F3E5F5', to: '#E1BEE7', icon: '#8E44AD' },
  ...
  dailydhikr: { from: '#E8F5E9', to: '#C8E6C9', icon: '#2E7D32' },
...
export const tilesDark: Record<keyof typeof tiles, { from: string; to: string }> = {
  ...
  dailydhikr: { from: '#15241A', to: '#0D1A12' },
