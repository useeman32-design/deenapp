...
#  • Shop product management now has gallery thumbnail/delete/reorder controls and variant storage with per-variant title/options/SKU/price/stock/media_id. Native variant selector/display and video playback remain next.
