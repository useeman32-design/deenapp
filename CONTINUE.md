...
#  • Native shop product detail now consumes the managed gallery, supports thumbnail selection, renders uploaded videos with expo-video, and displays returned variant options/prices. Live product-detail failures no longer fall back to bundled demo products.
