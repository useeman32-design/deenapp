...
export type ShareKind = 'video' | 'post' | 'dua' | 'verse' | 'article' | 'hadith' | 'ruqyah' | 'seerah' | 'prophets' | 'tafsir' | 'athkar' | 'names' | 'quiz' | 'riddle' | 'joke' | 'group'; /* pass 83-25 — + group (share.php learned t=group too) */
