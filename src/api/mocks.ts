...
export const MOCK_COURSES: Course[] = [
  ...
  },
  {
    ...
    description: 'Word-by-word meaning and context of the short surahs you recite every day.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 15,
    category: 'Tafsir',
  ...
  {
    id: 5,
    title: 'Aqeedah: The Foundations of Faith',
    slug: 'aqeedah-foundations',
    description: 'The six pillars of iman, explained clearly from Qur’an and Sunnah.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 10,
    category: 'Aqeedah',
  ...
  {
    id: 6,
    title: 'Tauhid: Knowing Allah',
    slug: 'tauhid-knowing-allah',
    description: 'Allah’s names, attributes and rights — the heart of Islamic belief.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 14,
    category: 'Tauhid',
  },
  {
    ...
    slug: 'arabic-reading-writing',
    description: 'From the alphabet to reading the Qur’an with confidence.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 20,
    category: 'Arabic',
  },
  /* pass 83-29 — catalog grown to 20 courses (owner: "add like 20, make your
   * research, and add 10 professional lectures and lessons and their quizzes").
   * Slugs with real curricula + quizzes in tools/courses.tsx are marked ★. */
  {
    id: 8,
    title: 'Sciences of Hadith ★',
    slug: 'hadith-sciences',
    description: 'How scholars graded narrations: isnad, matn, sahih, hasan, da’if — the professional field of mustalah.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 10,
    category: 'Hadith',
  },
  {
    ...
    slug: 'ulum-quran',
    description: 'How the Qur’an was revealed, preserved, and interpreted — asbab al-nuzul, abrogation, and tafsir method.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 10,
    category: 'Qur’an',
  },
  {
    ...
    slug: 'arabic-grammar',
    description: 'Nahw and sarf foundations: i’rab, sentence types, and the ten verb forms that unlock the classical texts.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 12,
    category: 'Arabic',
  ...
  {
    id: 11,
    title: 'Fiqh of Halal Finance ★',
    slug: 'halal-finance',
    description: 'Riba, contracts, crypto, mortgages and investing — a practical fiqh of money for the modern Muslim.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 10,
    category: 'Fiqh',
  ...
  {
    id: 12,
    title: 'Fiqh of Marriage & Family ★',
    slug: 'muslim-family',
    description: 'Khitbah to mahr to rights and duties — building a home on the Prophet’s ﷺ blueprint.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 10,
    category: 'Fiqh',
  },
  {
    ...
    slug: 'dawah-skills',
    description: 'Invite to the way of your Lord — methodology, manners, and answering the hard questions.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 8,
    category: 'Da’wah',
  ...
  {
    id: 14,
    title: 'Time Management the Prophetic Way ★',
    slug: 'prophetic-productivity',
    description: 'Barakah in the hours: goal-setting, deep work, and the daily rhythm of the salaf — a professional productivity course.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 8,
  ...
  {
    id: 15,
    title: 'Public Speaking & Khutbah Craft ★',
    slug: 'public-speaking',
    description: 'From jitters to jumu’ah: structure, voice, and presence for khateebs, teachers and professionals.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 8,
    category: 'Professional',
  ...
  {
    id: 16,
    title: 'Teaching Islam Effectively ★',
    slug: 'teaching-islam',
    description: 'Lesson design, classroom management and tarbiyah — for madrasah teachers, halaqah leads and parents.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 8,
    category: 'Professional',
  ...
  {
    id: 17,
    title: 'Research & Study Skills for Students ★',
    slug: 'study-research',
    description: 'Note-taking, citation, memorization science and exam strategy — professional study craft for every learner.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 8,
    category: 'Professional',
  ...
  {
    id: 18,
    title: 'Hajj & Umrah: The Complete Guide',
    slug: 'hajj-umrah',
    description: 'Every manasik step-by-step — ihram to tawaf to the farewell, with common mistakes to avoid.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 9,
    category: 'Fiqh',
  },
  {
    ...
    slug: 'ramadan-prep',
    description: 'Make this your best Ramadan: pre-Ramadan training, worship plans, and the last-ten strategy.',
    cover_image: null,
    level: 'Beginner',
    lessons_count: 6,
    category: 'Worship',
  ...
  {
    id: 20,
    title: '40 Hadith of Imam al-Nawawi',
    slug: 'nawawi-40',
    description: 'The famous collection every Muslim should know — text, explanation and practical takeaways.',
    cover_image: null,
    level: 'Intermediate',
    lessons_count: 10,
    category: 'Hadith',
