...
function ReaderInner() {
  ...
  const marks = useMemo(
    () =>
      new Set(
        bmAyah.list
          .filter((i) => i.item_id.startsWith(`${n}:`))
          .map((i) => Number(i.item_id.split(":")[1])),
      ),
    [bmAyah.list, n],
  );
  ...
  const [mode, setMode] = useState<Mode>(() =>
    (globalThis as unknown as { __dlReadMode?: Mode }).__dlReadMode === "mushaf"
      ? "mushaf"
      : "reading",
  );
  useEffect(() => {
  ...
  useEffect(() => {
    if (reciterOpen) audio.refreshReciters();
  }, [reciterOpen]);
  ...
  useEffect(() => {
    if (!isLive()) return;
    void quranStreakLog();
    void quranStreak().then((r) => {
      if (r) setStreak(r.current);
    });
  }, []);
  ...
  const [loopTo, setLoopTo] = useState(
    Math.min((startAyah || 1) + 4, meta?.ayahs ?? 7),
  );
  ...
  const [flashAyah, setFlashAyah] = useState<number | null>(
    startAyah > 1 ? startAyah : null,
  );
  ...
  useEffect(() => {
    ...
    if (
      ...
      router.replace({
        pathname: "/read/[id]",
        params: { id: String(audio.surah), ayah: "1" },
      } as never);
    }
    ...
    <View style={{ flex: 1, backgroundColor: d.bg }}>
      ...
      >
        <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            <T
              v="h2"
              style={{ color: d.text, fontWeight: "800", fontSize: 16.5 }}
              numberOfLines={1}
            >
              {mode === "mushaf"
                ? (QURAN.find((x) => x.number === mushafSurah)?.english ??
                  meta.english)
                : meta.english}
            </T>
            <T
              v="caption"
              style={{ color: d.faint, fontSize: 10, marginTop: 1 }}
              numberOfLines={1}
            >
              {mode === "mushaf"
                ? `${QURAN.find((x) => x.number === mushafSurah)?.name ?? meta.name} · uthmani mushaf`
                : `${meta.name} · ${meta.ayahs} verses · ${meta.revelation}`}
            </T>
          </View>
          ...
          <Pressable
            ...
            onPress={() => {
              haptic.selection();
              setLang((l) => {
                const i = TR_LANGS.findIndex((x) => x.id === l);
                return TR_LANGS[(i + 1) % TR_LANGS.length].id;
              });
            }}
            style={{
              flexDirection: "row",
          ...
          >
            ...
            <T
              v="caption"
              style={{ color: d.subtext, fontWeight: "800", fontSize: 10.5 }}
            >
              {TR_LANGS.find((x) => x.id === lang)?.code ?? "EN"}
            </T>
          </Pressable>
          <Pressable
            ...
            onPress={() =>
              mode === "reading"
                ? enterMushaf()
                : (haptic.selection(), setMode("reading"))
            }
            style={{
              flexDirection: "row",
              alignItems: "center",
          ...
          >
            <FontAwesome5
              name={mode === "reading" ? "book-open" : "list-ul"}
              size={10}
      ...
      {mode === "reading" ? (
        ...
        >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <T
                    v="caption"
                    style={{ color: d.faint, fontSize: 9.5, fontWeight: "700" }}
                  >
                    AYAH {arNum(a.ayah)}
                  </T>
                </View>
                ...
                {lang === "en" && a.english ? (
                  <T v="bodyS" style={{ color: d.subtext, marginTop: 10 }}>
                    {a.english}
                  </T>
                ) : null}
                {lang === "ha" && a.hausa ? (
                ...
                {lang !== "en" && lang !== "ha" && trMap[`${n}:${a.ayah}`] ? (
                  <T
                    ...
                    style={{
                      color: d.subtext,
                      marginTop: 10,
                      writingDirection: lang === "ur" ? "rtl" : undefined,
                    }}
                  >
                    {trMap[`${n}:${a.ayah}`]}
                  </T>
                ...
                >
                  ...
                  >
                    ...
                    audio.loading ? (
                      ...
                      <FontAwesome5
                        ...
                        size={11}
                        color={
                          activeAyah === a.ayah && audio.playing
                            ? isDark
                              ? "#4AE38F"
                              : "#1D6F42"
                            : d.faint
                  ...
                  >
                    <FontAwesome5
                      name="bookmark"
                      size={11}
                      solid={marks.has(a.ayah)}
                      color={marks.has(a.ayah) ? "#E8C96A" : d.faint}
                    />
                    <T
                      v="caption"
                      style={{
                        fontSize: 10.5,
                        fontWeight: "700",
                        color: marks.has(a.ayah) ? "#E8C96A" : d.subtext,
                      }}
                    >
                      Save
                    </T>
                  ...
                  <Pressable
                    onPress={() => {
                      ...
                      setShareAyah({
                        arabic: a.arabic,
                        meaning: (lang === "ha" && a.hausa) || a.english || "",
                        ref: `${meta.english} ${n}:${a.ayah}`,
                        route: `/read/${n}?ayah=${a.ayah}`,
                      });
                    }}
                    style={{
                      flexDirection: "row",
          ...
          {!data ? (
            <T v="bodyS" style={{ textAlign: "center", marginTop: 30 }}>
              Loading surah…
            </T>
          ) : null}
        </ScrollView>
      ...
      <Modal
        ...
        animationType="slide"
        transparent
        onRequestClose={() => setLoopOpen(false)}
      >
        <Pressable
          style={{
            flex: 1,
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <T
                  v="h3"
                  style={{ fontWeight: "800", fontSize: 14.5, color: d.text }}
                >
                ...
                >
                  Loop one ayah or a range — perfect for hifz
                </T>
              </View>
              ...
              {[
                ...
                >
                  ...
                  <View style={{ alignItems: "center" }}>
                    <T
                      v="caption"
                      style={{ fontSize: 8, fontWeight: "800", color: d.faint }}
                    >
                      {lbl}
                    </T>
                    <T
            ...
            >
                ...
                >
                  <T
                    ...
                    style={{
                      ...
                      fontWeight: "800",
                      color:
                        perAyah === c && !customPer ? "#E8C96A" : d.subtext,
                    }}
                  >
                    {c}×
                  </T>
              ...
              <View
                style={{
                  ...
                  borderRadius: 11,
                  borderWidth: 1,
                  borderColor: customPer
                    ? "rgba(212,175,55,0.55)"
                    : d.cardBorder,
                  backgroundColor: customPer
                    ? "rgba(212,175,55,0.12)"
                    : d.bgSoft,
                  paddingHorizontal: 8,
                  gap: 4,
              ...
              >
                <TextInput
                  value={customPer}
                  onChangeText={(tx) => {
                    const nn = parseInt(tx.replace(/\D/g, ""), 10);
                    setCustomPer(tx.replace(/\D/g, ""));
                    if (nn && nn > 0 && nn <= 100) setPerAyah(nn);
                  }}
                  ...
                  style={{
                    ...
                    fontSize: 13,
                    fontWeight: "800",
                    color: customPer ? "#E8C96A" : d.subtext,
                    textAlign: "center",
                  }}
                />
                <T
                  ...
                  style={{
                    fontSize: 10,
                    fontWeight: "800",
                    color: customPer ? "#E8C96A" : d.faint,
                  }}
                >
                  ×
                </T>
              ...
              {[1, 2, 3, 5, 0].map((c) => (
                <Pressable
                  ...
                  style={{
                    ...
                    borderWidth: 1,
                    borderColor:
                      loopCycles === c ? "rgba(212,175,55,0.55)" : d.cardBorder,
                    backgroundColor:
                      loopCycles === c ? "rgba(212,175,55,0.12)" : d.bgSoft,
                  }}
                >
                  <T
                    v="caption"
                    style={{
                      fontSize: 11,
                      fontWeight: "800",
                      color: loopCycles === c ? "#E8C96A" : d.subtext,
                    }}
                  >
                    {c === 0 ? "∞" : `${c}×`}
                  </T>
            ...
            <Pressable
              onPress={() => {
                ...
                audio.setLoop({
                  ...
                  to,
                  perAyah: customPer
                    ? Math.max(1, Math.min(100, parseInt(customPer, 10) || 1))
                    : perAyah,
                  cycles: loopCycles,
                } as LoopCfg);
                setLoopOpen(false);
            ...
            >
              ...
              >
                Start loop at {n}:{Math.min(loopFrom, loopTo)}
              </T>
            </Pressable>
          </Pressable>
        </Pressable>
      ...
      {data && reciteAt != null ? (
        <ReciteMode
          ...
          startAt={
            reciteAll ? Math.max(0, (activeAyah ?? startAyah ?? 1) - 1) : 0
          }
          items={(reciteAll
            ? data.verses
            : data.verses.filter((v) => v.ayah === reciteAt)
          ).map((v) => ({
            surah: n,
            ayah: v.ayah,
            arabic: v.arabic,
      ...
      {barOpen ? (
        ...
        >
          <GlassPlayerBar
            ...
            title={
              QURAN.find((x) => x.number === (audio.surah ?? n))?.english ??
              meta.english
            }
            arabic={
              QURAN.find((x) => x.number === (audio.surah ?? n))?.name ??
              meta.name
            }
            ...
            right={
              ...
              >
                <Pressable
                  onPress={() => {
                    haptic.selection();
                    setReciteAt(activeAyah ?? startAyah ?? 1);
                    setReciteAll(true);
                  }}
                  hitSlop={6}
                  accessibilityLabel="recite whole surah"
                  style={{
                    width: 30,
                    height: 30,
                    borderRadius: 15,
                    borderWidth: 1,
                    borderColor: "rgba(44,110,143,0.5)",
                ...
                <Pressable
                  ...
                  style={{
                    width: audio.loop && audio.loop.surah === n ? 38 : 30,
                    height: 30,
                    borderRadius: 15,
                    borderWidth: 1.5,
                    borderColor:
                    ...
                    gap: 3,
                    paddingHorizontal:
                      audio.loop && audio.loop.surah === n ? 5 : 0,
                  }}
                >
                  <FontAwesome5
                    name="sync-alt"
                    size={11}
                    color={
                      audio.loop && audio.loop.surah === n ? "#E8C96A" : d.faint
                    }
                  />
                  {audio.loop && audio.loop.surah === n ? (
                    <T
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
            ...
            <View style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                {QURAN.find((x) => x.number === switchAsk)?.english} — switch to{" "}
                {meta.english}?
              </T>
            </View>
          </View>
          <View style={{ flexDirection: "row", gap: 8, marginTop: 10 }}>
            ...
            >
              <T
                v="caption"
                style={{ color: d.subtext, fontWeight: "800", fontSize: 11 }}
              >
                Keep playing
              </T>
            </Pressable>
      ...
      {audio.announcement ? (
        ...
        >
          ...
          <View style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              UP NEXT — PLAYING IN {countdown ?? 5}…
            </T>
            <View
            ...
            >
              ...
              >
                {
                  QURAN.find((x) => x.number === audio.announcement!.surah)
                    ?.english
                }
              </T>
              <T
      ...
      {reciterOpen ? (
        <View
          style={{
            ...
            inset: 0,
            zIndex: 90,
            backgroundColor: "rgba(4,8,6,0.7)",
            justifyContent: "flex-end",
          }}
        >
          <Pressable
            style={{ flex: 1 }}
            onPress={() => setReciterOpen(false)}
          />
          <View
            style={{
              backgroundColor: d.card,
          ...
          >
            <T
              ...
              style={{
                ...
                fontWeight: "800",
                fontSize: 15,
                marginBottom: streak != null && streak > 0 ? 4 : 12,
              }}
            >
              Choose a reciter
            </T>
            {streak != null && streak > 0 ? (
              <T v="caption" style={{ color: d.faint, marginBottom: 10 }}>
