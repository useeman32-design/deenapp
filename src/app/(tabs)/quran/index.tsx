...
/**
 * Qur'an & Hadith hub — pattern header with gold accents and the two premium
 * cards (emerald Qur'an · gold Hadith). pass 83-38d: Quran Shazam and the
 * Seerah/Courses/Quiz shortcut buttons are removed (owner).
 */
