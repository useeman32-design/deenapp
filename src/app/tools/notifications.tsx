    ...
    const kind: Notif["kind"] =
      type === "chat_message"
        ...
        : type.includes("follow")
          ...
          : type.includes("like")
            ? "like"
            : type.includes("repost") || type.includes("share")
              ? "repost"
  ...
  const tap = (n: Notif) => {
    ...
    if (
      ...
      const post =
        n.entityType === "post"
          ? n.entityId
          : (n as Notif & { postId?: number }).postId;
      router.push(`/tools/post?id=${post ?? n.entityId}${comment}`);
      return;
    }
            ...
            return (
              ...
              >
                ...
                <View style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <T
                    v="caption"
                    style={{ fontSize: 9.5, color: d.faint, marginTop: 2 }}
                  >
                    {n.ago} ago
                  </T>
                </View>
